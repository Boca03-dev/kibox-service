...
const { createConfiguration, getUserConfigurations, deleteConfiguration, generateConfiguration, getAllConfigurations } = require('../controllers/configurationController');
